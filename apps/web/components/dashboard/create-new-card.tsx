  ...
  return (
    ...
    >
      ...
      <div className="relative mb-4 flex h-16 w-16 items-center justify-center rounded-2xl border border-surface-700 bg-surface-800/50 transition-all duration-300 group-hover:scale-110 group-hover:border-gold-500/30 group-hover:bg-gold-500/10">
        <Plus className="h-8 w-8 text-surface-500 transition-all duration-300 group-hover:text-gold-500" />
      </div>
      ...
      {/* Sparkles accent */}
      <Sparkles className="absolute right-4 top-4 h-4 w-4 text-surface-700 transition-all duration-300 group-hover:text-gold-500/50" />
    </Link>
  );
}
